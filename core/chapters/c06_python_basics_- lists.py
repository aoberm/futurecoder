...
class UsingBreak(Page):
    title = "(optional) Using `break` to end a loop early"
...
class GettingElementsAtPosition(Page):
    title = "(optional) Getting elements at a position, `range()`, and `len()`"
...
class GettingElementsAtPositionExercises(Page):
    title = "(optional) Exercises with `range()` and `len()`"
...
class CallingFunctionsTerminology(Page):
    title = "(optional) Terminology: Calling functions and methods"
...
class FunctionsAndMethodsForLists(Page):
    title = "(optional) Functions and Methods for Lists"
...
class MoreListFunctionsAndMethods(Page):
    title = "(optional) More List Functions and Methods"
...
class StringMethodsUnderstandingMutation(Page):
    title = "(optional) String Methods and Immutability"
...
class HowToFindInformationWithGoogleAndMore(Page):
    title = "(optional) How to Find Information with Google, and more"
...
class UnderstandingProgramsWithPythonTutor(Page):
    title = "(optional) Understanding Programs with Python Tutor"
...
class EqualsVsIs(Page):
    title = "(optional) `==` vs `is`, and Having Multiple Names for One Value"
...
class ModifyingWhileIterating(Page):
    title = "(optional) Modifying while Iterating"
